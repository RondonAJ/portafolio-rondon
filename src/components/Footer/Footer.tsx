...
export default function Footer() {
  ...
  return (
    <footer className="bg-deep-blue border-t border-cyan/20 py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center">
          <p className="text-white/70 text-sm sm:text-base">
            © {currentYear} <span className="text-cyan font-semibold">Rondón</span>. 
            Construido con{' '}
            <a
